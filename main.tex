...
\large A Dissertation Submitted \\ to the Graduate School \\ University of Arkansas at Little Rock\\[1.5cm] % University name
...
\input{Chapters/SocialMediaAndRealLifeEvents}
\input{Chapters/LiteratureReview}
\input{Chapters/Challenges} 
\input{Chapters/EiimLifeCycle} 
\input{Chapters/Evaluations}
\input{Chapters/PotentialApplications} 
