...
Interim Graduate Dean: \hspace{0.5cm} \hrulefill  \\
...
\begin{center} \textbf{\textit{\LARGE Acknowledgements}} \end{center}
\doublespacing
\setlength{\parindent}{1cm}
