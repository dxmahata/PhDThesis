...
\label{ConclusionAndFutureWork} % For referencing the chapter elsewhere, use \ref{Chapter1} 

\lhead{Chapter 3. \emph{Conclusion and Future Work}} % This is for the header on each page - perhaps a shortened title
