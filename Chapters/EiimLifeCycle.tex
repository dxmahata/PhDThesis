...
\begin{itemize}
\item \textbf{Parts-of-speech tagging} - The Natural Language Toolkit (http://nltk.org) POS tagger is used for tagging the raw text of the tweets. All the words of a tweet is assigned one of the following parts-of-speech:
\begin{itemize}
\item Noun
\item Adjective
\item Verb
...
\item \textbf{Special Character Detection}
...
After the data cleansing step, the duplicate detection scheme identifies both the tweets to be same and only maintain a single copy. This process occurs in real-time. A hashtable is maintained in the memory that is constantly searched for the presence of 
